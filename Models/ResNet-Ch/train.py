...
os.makedirs("Models/ResNet-Ch/model_archive", exist_ok=True)
...
for epoch in range(50):  # Number of epochs
    ...
    epoch_model_path = f"Models/ResNet-Ch/model_archive/model_epoch_{epoch}.pth"
    ...
    plot_pointclouds(train_pred_pc, train_sample_pc.numpy(), f"Models/ResNet-Ch/epoch_archive/train_epoch_{epoch}.png")
    plot_pointclouds(val_pred_pc, val_sample_pc.numpy(), f"Models/ResNet-Ch/epoch_archive/val_epoch_{epoch}.png")
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/ResNet-Ch/training_loss_plot.png")
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/ResNet-Ch/validation_loss_plot.png")
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/ResNet-Ch/training_validation_loss_plot.png")
plt.close()
