...
if __name__ == "__main__":
    # Paths
    model_path_epoch1 = "Models/ResNet-Ch/model_archive/model_epoch_0.pth"  # 1st epoch model path
    model_path_best = "Models/ResNet-Ch/best_model_single_shot.pth"  # Best model path
    ...
    output_path = "Models/ResNet-Ch/pointcloud_comparison_full4.png"  # Output plot path
