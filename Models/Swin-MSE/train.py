...
os.makedirs("Models/Swin-MSE/model_archive", exist_ok=True)

print("Training loop")
# Save the best model
best_validation_loss = float('inf')
best_train_loss = float('inf')
best_model_path = "Models/Swin-MSE/best_model_single_shot.pth"
...
for epoch in range(50):  # Number of epochs
    ...
    epoch_model_path = f"Models/Swin-MSE/model_archive/model_epoch_{epoch}.pth"
    ...
    plot_pointclouds(train_pred_pc, train_sample_pc.numpy(), f"Models/Swin-MSE/epoch_archive/train_epoch_{epoch}.png")
    plot_pointclouds(val_pred_pc, val_sample_pc.numpy(), f"Models/Swin-MSE/epoch_archive/val_epoch_{epoch}.png")
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/Swin-MSE/training_loss_plot.png")
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/Swin-MSE/validation_loss_plot.png")
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("Models/Swin-MSE/training_validation_loss_plot.png")
plt.close()
