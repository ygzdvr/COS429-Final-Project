...
if __name__ == "__main__":
    # Paths
    model_path = "Models/ViT-Ch/best_model_single_shot.pth"  # Trained model path
    image_path = "Dataset/Images/LowResolution/test/airplane/airplane_0644/5.png"  # Test image path
    pc_path = "Dataset/PointClouds/LowResolution/test/airplane/airplane_0644.npy"  # Corresponding point cloud path
    output_path = "Models/ViT-Ch/pointcloud_comparison_vit.png"  # Output plot path
